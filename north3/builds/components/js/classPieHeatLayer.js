...
// constructor
global.PieHeatLayer = function(node){

  // call the parent constructor, make sure 'this' is set correctly
  Layer.call(this, node);

  // initialize PieHeatLayer-specific properties
};
global.PieHeatLayer.prototype = Object.create(Layer.prototype);
global.PieHeatLayer.prototype.constructor = PieHeatLayer;

global.PieHeatLayer.prototype.getChartType = function(){
  return 'heatmap';
};

global.PieHeatLayer.prototype.getLegend = function(){
...
global.PieHeatLayer.prototype.hide = function(){
...
global.PieHeatLayer.prototype.show = function(){
  ...
  lg.div.find('.chart-div[data="heatmap"] .slider_bg.patch [data="' + catIndex + '"]')
    .addClass('active')
...
global.PieHeatLayer.prototype.getClassificationData = function(){
  var a = [];
  var node = this.getNode();
  var lm = this.getLayerManager();
  var catIndex = lm.getCategoryIndex();
...
global.PieHeatLayer.prototype.setClusterRadius = function(data){
  this._clusterRadius = data;
};

global.PieHeatLayer.prototype.getClusterRadius = function(){
  return this._clusterRadius;
};

global.PieHeatLayer.prototype.showConfig = function(){
  var lyr = this;
  var node = this.getNode();
...
global.PieHeatLayer.prototype.draw = function(){
  ...
  var fld_id = "y" + yearIndex + "v" + (Number(catIndex)+1);
